...
The multinomial model adds useful detail for hesitant respondents. For recommendation “Yes” vs “No” (reference category), Q13 remained a strong positive predictor (RRR 1.585, p<0.0001), while dependence concerns (Q12) were associated with a lower relative risk ratio for “Yes” vs “No” (RRR 0.794, p=0.0239). For the “Not sure” category, gender remained significant (RRR 2.171, p=0.0093), but most attitudinal predictors were weaker. This indicates that uncertainty is not only a neutral midpoint; it reflects unresolved risk beliefs that require targeted communication.
