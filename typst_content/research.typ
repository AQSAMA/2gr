...
#p("Iraq’s mental health burden developed under repeated war, displacement, sanctions, and political instability. This history still shapes how people understand psychiatric care today. Evidence from Iraqi and regional reporting shows that exposure to conflict, bereavement, and social disruption increased anxiety, depression, and trauma-related conditions in both urban and displaced populations #strong[(Saied et al., 2023; Younis & Khunda, 2020)].")
#p("At the same time, service capacity did not expand at the same pace as need. Iraqi psychiatry moved through periods of growth and then major workforce loss, especially after conflict-related migration waves, which left a long gap between population demand and specialist availability #strong[(Younis & Khunda, 2020; Sadik et al., 2010)].")
#p("Current system-level indicators support this gap. National commentary describes a continuing shortage of psychiatrists, limited specialized facilities, and weak access in many areas outside major centers #strong[(Saied et al., 2023)]. Earlier Iraqi public-health work also documented a high burden of common mental disorders and a very low proportion of people with mental disorders receiving formal treatment #strong[(Sadik et al., 2010)]. Evidence from post-conflict care literature further shows that service use is shaped not only by availability, but also by fear of labeling, social judgment, and delayed help-seeking even when symptoms are significant #strong[(Burnam et al., 2009)].")
#p("These structural and social conditions make psychiatric medication use a public-health issue, not only a clinical issue. When access to specialist follow-up is limited, decisions about whether psychiatric medicines are acceptable, safe, or socially risky often move into family and community spaces. In Iraq, those decisions are influenced by collective memory of conflict, concerns about dependence, and distrust of mental health services, while public education and mental health literacy remain uneven across groups #strong[(Saied et al., 2023; Sadik et al., 2010)].")
#h2("B. Problem Statement")
#p("Iraq faces a double challenge. The first challenge is a treatment-capacity gap, with limited workforce and service coverage relative to the burden of mental disorders. The second challenge is a public-acceptance gap, where stigma and negative social beliefs can reduce care-seeking, delay treatment initiation, and weaken long-term medication use. Iraqi evidence indicates that many people recognize biological and psychosocial causes of mental illness, yet still hold restrictive social attitudes about people living with mental disorders #strong[(Sadik et al., 2010)]. This pattern means awareness alone does not automatically produce acceptance.")
...
#p("The present survey aligns with earlier Iraqi evidence that public understanding and stigma can coexist. #strong[Sadik et al. (2010)] reported that many Iraqis accepted biomedical causes of mental illness while still expressing strong social distance and blame. Our findings show a comparable duality: many respondents would recommend medication, yet large proportions still consider it unsafe or socially problematic. Evidence from Baghdad university students also reports persistent stigma despite high educational exposure, which is consistent with the current sample profile where high education did not independently remove negative medication beliefs #strong[(Hussein Alwan et al., 2025)].")
#p("Regional literature helps explain why concern about dependence and overprescribing remained strong in our models. Arab mental health literacy studies report persistent misconceptions about psychiatric disorders and treatment, including stigma-related beliefs and limited confidence in professional care in student and community groups #strong[(Elyamani et al., 2021)]. Our Q12 distribution, where 67.40% agreed with the statement that most psychiatric medications cause dependence, is consistent with that broader pattern. At the same time, the positive effect of Q13, confidence that modern psychiatric medications are safer than older ones, suggests that confidence in newer medications can partially offset this concern when communication is clear.")
#p("The findings also fit Iraqi service-use realities. Iraqi clinicians have reported that many patients still visit faith healers before or alongside psychiatric care, with barriers linked to accessibility, cultural beliefs, and mistrust of formal services #strong[(Younis et al., 2020)]. This pathway helps interpret why recommendation willingness in our sample was higher than perceived safety and acceptability. People may approve treatment in principle but still delay formal care when risk perceptions and social narratives remain unresolved.")
#p("Our results are also compatible with broader adherence evidence. Systematic reviews show that adherence is strongly affected by social support, stigma, and perceived treatment burden rather than diagnosis alone #strong[(Gast & Mathes, 2019; Abdisa et al., 2020)]. The current survey did not measure longitudinal adherence, but the strong effects of fear and dependence beliefs indicate that these same mechanisms are active at the acceptance stage in Iraq. In this sense, acceptance barriers and adherence barriers likely sit on the same pathway.")
...
#p("At public health level, the results support integrating anti-stigma and medication-literacy components into primary care mental health services. Regional evidence shows that integrated primary care models improve outcomes in low-resource settings when they combine clinical care with structured education and follow-up #strong[(Cubillos et al., 2021)]. For Iraq, this means linking physician diagnosis, pharmacist counseling, and brief public education in one pathway rather than treating these as separate activities.")
...
#p("National guidance should also formalize integrated mental health care in primary care settings, with defined roles for psychiatrists, primary care physicians, and pharmacists. Regional evidence supports integrated models for improving access and outcomes in resource-limited systems #strong[(Cubillos et al., 2021; Okasha et al., 2025)]. For Iraq, this model can reduce specialist bottlenecks and create earlier treatment contact points.")
#p("Policy should also support public campaigns that include religious and community leaders to address care delays linked to traditional help-seeking pathways #strong[(Younis et al., 2020)]. The aim is not to dismiss cultural practices, but to align them with timely referral to formal mental health services.")
...
#set-running-head("Appendix A")
#section-title("Appendix A. Detailed Statistical Analysis Output")
#appendix-subtitle("Psychiatric Medication Use and Public Acceptance in Iraq — Unified Survey Analysis (N=877)")
#para("This script now provides a single unified output with main/clean models and clearly labeled exploratory analyses.")
#h2("Main/Clean Analysis (Publication-Ready)")
#h2("1) Hierarchical Block Logistic Regression (Outcome: Q8 Yes vs No)")
#bullets(("Complete-case n (primary hierarchical models): #strong[647]",))
#datatable(("Model block", "Formula summary", "McFadden pseudo R²", "LLR p-value"), (left, left, right, right), (("Block 1 (mle)", "Recommend_Binary ~ Age_Binary + Gender_Binary + Edu_Binary + Married_Binary", "0.0040", "0.5037"), ("Block 2 (mle)", "Recommend_Binary ~ Age_Binary + Gender_Binary + Edu_Binary + Married_Binary + PriorUse_Binary", "0.0116", "0.0847"), ("Block 3 (mle)", "Recommend_Binary ~ Age_Binary + Gender_Binary + Edu_Binary + Married_Binary + PriorUse_Binary + Q11 + Q12 + Q13 + Fear_Binary", "0.0686", "<0.0001"),))
#h3("Final Primary Block (Block 3) — Adjusted Odds Ratios")
#datatable(("Predictor", "Adjusted OR (95% CI)", "p-value"), (left, right, right), (("Intercept", "1.128 (0.298 to 4.273)", "0.8597"), ("Age_Binary", "0.961 (0.583 to 1.582)", "0.8752"), ("Gender_Binary", "1.516 (1.043 to 2.205)", "0.0294"), ("Edu_Binary", "1.381 (0.750 to 2.542)", "0.3005"), ("Married_Binary", "1.075 (0.632 to 1.827)", "0.7904"), ("PriorUse_Binary", "1.342 (0.800 to 2.252)", "0.2645"), ("Q11", "0.830 (0.696 to 0.991)", "0.0396"), ("Q12", "0.869 (0.701 to 1.078)", "0.2008"), ("Q13", "1.507 (1.248 to 1.820)", "<0.0001"), ("Fear_Binary", "0.504 (0.358 to 0.711)", "<0.0001"),))
#h3("Sensitivity Model Adding Proximal Beliefs (Q6/Q7)")
#bullets(("Complete-case n (sensitivity model): #strong[406]", "McFadden pseudo R²: #strong[0.2440]", "Fit type: #strong[mle]", "This sensitivity model is reported separately because Q6 and Q7 are conceptually close to Q8 and can dominate explanatory variance."))
#h2("2) Multinomial Logistic Regression Preserving Hesitation (Q8 = No / Yes / Not sure)")
#bullets(("Complete-case n: #strong[837]", "Model log-likelihood: #strong[-748.910]", "Fit type: #strong[mle]"))
#para("Reference outcome in statsmodels is the lowest coded category; coefficients are shown for non-reference outcome equations.")
#datatable(("Outcome equation", "Predictor", "Relative risk ratio (95% CI)", "p-value"), (left, left, right, right), (("Q8=1 vs ref", "const", "0.936 (0.264 to 3.317)", "0.9189"), ("Q8=1 vs ref", "Age_Binary", "0.947 (0.599 to 1.496)", "0.8139"), ("Q8=1 vs ref", "Gender_Binary", "1.558 (1.097 to 2.214)", "0.0133"), ("Q8=1 vs ref", "Edu_Binary", "1.177 (0.661 to 2.095)", "0.5797"), ("Q8=1 vs ref", "Married_Binary", "0.967 (0.598 to 1.563)", "0.8903"), ("Q8=1 vs ref", "PriorUse_Binary", "1.387 (0.863 to 2.229)", "0.1763"), ("Q8=1 vs ref", "Q11", "0.873 (0.742 to 1.028)", "0.1028"), ("Q8=1 vs ref", "Q12", "0.794 (0.651 to 0.970)", "0.0239"), ("Q8=1 vs ref", "Q13", "1.585 (1.328 to 1.892)", "<0.0001"), ("Q8=2 vs ref", "const", "0.304 (0.046 to 2.013)", "0.2170"), ("Q8=2 vs ref", "Age_Binary", "1.094 (0.549 to 2.180)", "0.7983"), ("Q8=2 vs ref", "Gender_Binary", "2.171 (1.211 to 3.894)", "0.0093"), ("Q8=2 vs ref", "Edu_Binary", "1.300 (0.526 to 3.211)", "0.5692"), ("Q8=2 vs ref", "Married_Binary", "1.713 (0.863 to 3.399)", "0.1237"), ("Q8=2 vs ref", "PriorUse_Binary", "1.401 (0.704 to 2.789)", "0.3373"), ("Q8=2 vs ref", "Q11", "0.846 (0.662 to 1.080)", "0.1799"), ("Q8=2 vs ref", "Q12", "0.890 (0.660 to 1.199)", "0.4438"), ("Q8=2 vs ref", "Q13", "1.064 (0.820 to 1.381)", "0.6404"),))
#h2("Exploratory Analysis (Clearly Labeled)")
#h2("3) Contact Hypothesis: Users vs Non-Users on Core Beliefs (Q11-Q13)")
#bullets(("Users (Q31=1): #strong[127]", "Non-users (Q31=0): #strong[716]"))
#datatable(("Item", "User median", "Non-user median", "Mann-Whitney U p-value", "Cliff's delta", "Chi-square p-value", "Cramer's V", "N used"), (left, right, right, right, right, right, right, right), (("Q11 (Doctors prescribe medications more than necessary)", "3.00", "4.00", "0.0428", "-0.108", "0.1170", "0.094", "843"), ("Q12 (Most medications cause psychological or physical dependence)", "4.00", "4.00", "0.0317", "-0.112", "0.0428", "0.108", "840"), ("Q13 (Modern medications are safer than older ones)", "4.00", "3.00", "0.0002", "0.198", "0.0027", "0.139", "842"),))
#h2("4) Exploratory Stigma Phenotypes (K-Means on Standardized Q11-Q13)")
#datatable(("k", "Silhouette score"), (right, right), (("2", "0.274"), ("3", "0.272"), ("4", "0.303"),))
#bullets(("Selected k by maximum silhouette: #strong[4]",))
#datatable(("Profile", "Size n", "Q11 mean", "Q12 mean", "Q13 mean"), (right, right, right, right, right), (("0", "183", "4.404", "4.115", "4.311"), ("1", "230", "2.961", "2.804", "3.578"), ("2", "232", "2.694", "4.250", "3.720"), ("3", "223", "4.359", "4.291", "2.610"),))
#h2("5) Notes for Manuscript Positioning")
#bullets(("Hierarchical and multinomial modeling are suitable main-text analyses because they preserve response structure and clarify incremental explanatory value.", "K-means profiling should be presented as an exploratory secondary analysis.", "For stronger latent construct validation in future work, ordinal EFA/CFA with polychoric correlations is recommended on appropriately scoped item blocks."))
#pagebreak(weak: true)
#h2("Demographics Summary")
#datatable(("Variable", "Category", "Count", "Percentage"), (left, left, right, right), (("Gender", "Male", "244", "28.05%"), ("Gender", "Female", "626", "71.95%"), ("Age", "18-25", "651", "74.57%"), ("Age", "26-35", "153", "17.53%"), ("Age", "36-45", "44", "5.04%"), ("Age", "46-60", "24", "2.75%"), ("Age", ">60", "1", "0.11%"), ("Educational level", "Primary", "5", "0.57%"), ("Educational level", "Middle School", "0", "0.00%"), ("Educational level", "High School", "61", "6.99%"), ("Educational level", "Institute/Diploma", "0", "0.00%"), ("Educational level", "University", "689", "78.92%"), ("Educational level", "Postgraduate", "118", "13.52%"), ("Marital status", "Single", "684", "78.44%"), ("Marital status", "Married", "183", "20.99%"), ("Marital status", "Divorced", "3", "0.34%"), ("Marital status", "Widowed", "2", "0.23%"),))
#h2("Core Beliefs Likert Distribution")
#datatable(("Question", "Disagree %", "Neutral %", "Agree %"), (left, right, right, right), (("Q11", "13.78%", "34.67%", "51.55%"), ("Q12", "4.95%", "27.65%", "67.40%"), ("Q13", "12.18%", "35.86%", "51.95%"),))
#h2("Correlation Matrix: Primary Beliefs")
#datatable(("Variable", "Q11", "Q12", "Q13", "Concern", "Acceptance", "Recommend"), (left, right, right, right, right, right, right), (("Q11", "1.000", "0.269", "-0.066", "0.059", "-0.085", "-0.086"), ("Q12", "0.269", "1.000", "-0.038", "0.058", "-0.163", "-0.087"), ("Q13", "-0.066", "-0.038", "1.000", "-0.105", "0.026", "0.077"), ("Concern", "0.059", "0.058", "-0.105", "1.000", "-0.040", "-0.042"), ("Acceptance", "-0.085", "-0.163", "0.026", "-0.040", "1.000", "0.232"), ("Recommend", "-0.086", "-0.087", "0.077", "-0.042", "0.232", "1.000"),))
#h2("Acceptance by Prior Use")
#datatable(("Prior Use", "Recommend Yes %", "Sample n"), (left, right, right), (("Yes", "65.08%", "126"), ("No", "55.80%", "715"),))
#h2("General Attitudes Distribution")
#datatable(("Question", "Yes %", "Not sure %", "No %"), (left, right, right, right), (("Safety perception", "23.65%", "31.23%", "45.12%"), ("Acceptability", "30.80%", "17.70%", "51.49%"), ("Recommendation willingness", "57.65%", "11.62%", "30.72%"), ("Social concerns", "37.77%", "13.09%", "49.14%"),))
