...
\section*{2. LITERATURE REVIEW (SUPPORTIVE CONTEXT)}
...
\section*{3. METHODOLOGY (ORIGINAL CROSS-SECTIONAL STUDY)}
...
\subsection*{4.A Sample Profile and Descriptive Statistics}
...
\subsection*{4.B Main Outcome Distributions}
...
\subsection*{4.C Hierarchical Logistic Regression (Primary Model)}
...
\subsection*{4.D Multinomial Logistic Regression (No/Yes/Not Sure Structure)}
...
\subsection*{4.E The Contact Hypothesis (Users vs Non-Users)}
...
\subsection*{4.F Exploratory Stigma Phenotypes (Clearly Labeled)}
...
\subsection*{4.G Results Summary}
