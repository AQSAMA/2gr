...
\subsection*{Psychiatric Medication Use and Public Acceptance in Iraq — Unified Survey Analysis (N=877)}
This script now provides a single unified output with main/clean models and clearly labeled exploratory analyses.

\subsection*{Main/Clean Analysis (Publication-Ready)}
\subsection*{1) Hierarchical Block Logistic Regression (Outcome: Q8 Yes vs No)}
...
\begin{tabular}{llrr}
\hline
\textbf{Model block} & \textbf{Formula summary} & \textbf{McFadden pseudo R²} & \textbf{LLR p-value} \\
\hline
Block 1 (mle) & Recommend\_Binary \textasciitilde{} Age\_Binary + Gender\_Binary + Edu\_Binary + Married\_Binary & 0.0040 & 0.5037 \\
Block 2 (mle) & Recommend\_Binary \textasciitilde{} Age\_Binary + Gender\_Binary + Edu\_Binary + Married\_Binary + PriorUse\_Binary & 0.0116 & 0.0847 \\
Block 3 (mle) & Recommend\_Binary \textasciitilde{} Age\_Binary + Gender\_Binary + Edu\_Binary + Married\_Binary + PriorUse\_Binary + Q11 + Q12 + Q13 + Fear\_Binary & 0.0686 & <0.0001 \\
\hline
\end{tabular}
\end{center}
...
\begin{tabular}{lrr}
\hline
\textbf{Predictor} & \textbf{Adjusted OR (95\% CI)} & \textbf{p-value} \\
\hline
Intercept & 1.128 (0.298 to 4.273) & 0.8597 \\
Age\_Binary & 0.961 (0.583 to 1.582) & 0.8752 \\
Gender\_Binary & 1.516 (1.043 to 2.205) & 0.0294 \\
Edu\_Binary & 1.381 (0.750 to 2.542) & 0.3005 \\
Married\_Binary & 1.075 (0.632 to 1.827) & 0.7904 \\
PriorUse\_Binary & 1.342 (0.800 to 2.252) & 0.2645 \\
Q11 & 0.830 (0.696 to 0.991) & 0.0396 \\
Q12 & 0.869 (0.701 to 1.078) & 0.2008 \\
Q13 & 1.507 (1.248 to 1.820) & <0.0001 \\
Fear\_Binary & 0.504 (0.358 to 0.711) & <0.0001 \\
\hline
\end{tabular}
\end{center}
\#\#\# Sensitivity Model Adding Proximal Beliefs (Q6/Q7)

- Complete-case n (sensitivity model): 406 - McFadden pseudo R²: 0.2440 - Fit type: mle - This sensitivity model is reported separately because Q6 and Q7 are conceptually close to Q8 and can dominate explanatory variance.

\subsection*{2) Multinomial Logistic Regression Preserving Hesitation (Q8 = No / Yes / Not sure)}
- Complete-case n: 837 - Model log-likelihood: -748.910 - Fit type: mle
...
\begin{tabular}{llrr}
\hline
\textbf{Outcome equation} & \textbf{Predictor} & \textbf{Relative risk ratio (95\% CI)} & \textbf{p-value} \\
\hline
Q8=1 vs ref & const & 0.936 (0.264 to 3.317) & 0.9189 \\
Q8=1 vs ref & Age\_Binary & 0.947 (0.599 to 1.496) & 0.8139 \\
Q8=1 vs ref & Gender\_Binary & 1.558 (1.097 to 2.214) & 0.0133 \\
Q8=1 vs ref & Edu\_Binary & 1.177 (0.661 to 2.095) & 0.5797 \\
Q8=1 vs ref & Married\_Binary & 0.967 (0.598 to 1.563) & 0.8903 \\
Q8=1 vs ref & PriorUse\_Binary & 1.387 (0.863 to 2.229) & 0.1763 \\
...
Q8=2 vs ref & Age\_Binary & 1.094 (0.549 to 2.180) & 0.7983 \\
Q8=2 vs ref & Gender\_Binary & 2.171 (1.211 to 3.894) & 0.0093 \\
Q8=2 vs ref & Edu\_Binary & 1.300 (0.526 to 3.211) & 0.5692 \\
Q8=2 vs ref & Married\_Binary & 1.713 (0.863 to 3.399) & 0.1237 \\
Q8=2 vs ref & PriorUse\_Binary & 1.401 (0.704 to 2.789) & 0.3373 \\
...
\end{tabular}
\end{center}
\subsection*{Exploratory Analysis (Clearly Labeled)}
\subsection*{3) Contact Hypothesis: Users vs Non-Users on Core Beliefs (Q11-Q13)}
- Users (Q31=1): 127 - Non-users (Q31=0): 716

\begin{center}
\small
\begin{tabular}{lrrrrrrr}
\hline
\textbf{Item} & \textbf{User median} & \textbf{Non-user median} & \textbf{Mann-Whitney U p-value} & \textbf{Cliff's delta} & \textbf{Chi-square p-value} & \textbf{Cramer's V} & \textbf{N used} \\
\hline
...
\end{tabular}
\end{center}
\subsection*{4) Exploratory Stigma Phenotypes (K-Means on Standardized Q11-Q13)}
\begin{center}
\small
\begin{tabular}{rr}
\hline
...
\begin{tabular}{rrrrr}
\hline
\textbf{Profile} & \textbf{Size n} & \textbf{Q11 mean} & \textbf{Q12 mean} & \textbf{Q13 mean} \\
\hline
...
\end{tabular}
\end{center}
\subsection*{Core Beliefs Likert Distribution}
\begin{center}
\small
\begin{tabular}{lrrr}
\hline
\textbf{Question} & \textbf{Disagree \%} & \textbf{Neutral \%} & \textbf{Agree \%} \\
\hline
...
\end{tabular}
\end{center}
\subsection*{Correlation Matrix: Primary Beliefs}
\begin{center}
\small
\begin{tabular}{lrrrrrr}
\hline
\textbf{Variable} & \textbf{Q11} & \textbf{Q12} & \textbf{Q13} & \textbf{Concern} & \textbf{Acceptance} & \textbf{Recommend} \\
\hline
...
\end{tabular}
\end{center}
\subsection*{Acceptance by Prior Use}
\begin{center}
\small
\begin{tabular}{lrr}
\hline
\textbf{Prior Use} & \textbf{Recommend Yes \%} & \textbf{Sample n} \\
\hline
Yes & 65.08\% & 126 \\
No & 55.80\% & 715 \\
\hline
\end{tabular}
\end{center}
\subsection*{General Attitudes Distribution}
\begin{center}
\small
\begin{tabular}{lrrr}
\hline
\textbf{Question} & \textbf{Yes \%} & \textbf{Not sure \%} & \textbf{No \%} \\
\hline
...
\end{center}
\newpage
\subsection*{IV.A Sample Profile and Descriptive Statistics}
...
\end{figure}
\subsection*{IV.B Main Outcome Distributions}
...
\subsection*{IV.C Hierarchical Logistic Regression (Primary Model)}
...
\subsection*{IV.D Multinomial Logistic Regression (No/Yes/Not Sure Structure)}
...
\end{figure}
\subsection*{IV.E The Contact Hypothesis (Users vs Non-Users)}
...
\subsection*{IV.F Exploratory Stigma Phenotypes (Clearly Labeled)}
...
\end{figure}
\subsection*{IV.G Results Summary}
