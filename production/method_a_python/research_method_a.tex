...
The survey enrolled 877 respondents and produced the data summarized in the tables below. The full standalone survey report is available as a companion DOCX (survey\_results.docx). Section IV.A onwards interprets these results in detail.
...
\begin{tabular}{llrr}
\hline
\textbf{Variable} & \textbf{Category} & \textbf{Count} & \textbf{\%} \\
\hline
...
\end{tabular}
\end{center}
\subsection*{Main Attitudes and Beliefs}
\begin{center}
\small
\begin{tabular}{lrrr}
\hline
\textbf{Item} & \textbf{Yes (\%)} & \textbf{Not sure (\%)} & \textbf{No (\%)} \\
\hline
...
\begin{tabular}{lrrr}
\hline
\textbf{Belief item (5-point Likert)} & \textbf{Disagree (\%)} & \textbf{Neutral (\%)} & \textbf{Agree (\%)} \\
\hline
...
\end{tabular}
\end{center}
\subsection*{Hierarchical Logistic Regression — Final Block (n = 647)}
\begin{center}
\small
\begin{tabular}{lrr}
\hline
...
\subsection*{Multinomial Logistic Regression (n = 837)}
\begin{center}
\small
\begin{tabular}{lrrrr}
\hline
\textbf{Predictor} & \textbf{RRR Yes vs No (95\% CI)} & \textbf{p (Yes)} & \textbf{RRR Not sure vs No (95\% CI)} & \textbf{p (Not sure)} \\
\hline
...
\end{tabular}
\end{center}
\subsection*{Contact Hypothesis: Users vs Non-Users on Core Beliefs}
\begin{center}
\small
\begin{tabular}{lrrrr}
\hline
\textbf{Belief item} & \textbf{User median} & \textbf{Non-user median} & \textbf{Mann-Whitney U p} & \textbf{Cliff's delta} \\
\hline
...
\subsection*{Exploratory Stigma Phenotypes (k = 4 by silhouette)}
\begin{center}
\small
\begin{tabular}{rrrrr}
\hline
\textbf{Profile} & \textbf{n} & \textbf{Q11 mean} & \textbf{Q12 mean} & \textbf{Q13 mean} \\
\hline
