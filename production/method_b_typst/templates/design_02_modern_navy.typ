...
#let document(body) = {
  ...
  set page(paper: "a4", margin: 1.5cm, numbering: "1", number-align: center, header: align(right)[#text(size: 9pt, fill: navy)[Psychiatric Medication Use and Public Acceptance in Iraq]])
