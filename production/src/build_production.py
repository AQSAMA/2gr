...
SUPERVISOR_COVER = f"Dr. {SUPERVISOR}"
...
def _add_cover_page(doc: Document) -> None:
    ...
    _add_centered_paragraph(doc, SUPERVISOR_COVER, size=18, bold=True)
...
def _latex_cover_block() -> list[str]:
    ...
    return [
        ...
        f"{{\\Large\\bfseries {escape_latex(SUPERVISOR_COVER)}}}\\\\",
...
def _pdf_cover_story(styles: dict[str, ParagraphStyle]) -> list:
    ...
    story.append(Paragraph(SUPERVISOR_COVER, styles["centered_lg"]))
    story.append(Spacer(1, 14))
